...
my $help              = 0;
my $host              = undef;
my $port              = $ENV{DBIC_TEST_PORT} || $ENV{CATALYST_PORT} || 3000;
my $keepalive         = 0;
my $restart           = $ENV{DBIC_TEST_RELOAD} || $ENV{CATALYST_RELOAD} || 0;
my $background        = 0;
my $pidfile           = undef;
...
dbic_test_server.pl - Catalyst Testserver

=head1 SYNOPSIS

dbic_test_server.pl [options]
